/*
    Name:Purnendu Bhatt
    Roll No:MT2024031
    Program Description:Write a program to wait for data to be written into FIFO within 10 seconds, use select
...
/*
purnendu-bhatt@purnendu-bhatt-Inspiron-3501:~/systemsoftware/Software-Systems/Hands-On-List-II$ cc 22b.c
