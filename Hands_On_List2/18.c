/*
    Name:Purnendu Bhatt
    Roll No:MT2024031
    Program Description:Write a program to find out total number of directories on the pwd.
...
/*
purnendu-bhatt@purnendu-bhatt-Inspiron-3501:~/systemsoftware/Software-Systems/Hands-On-List-II$ cc 18.c
